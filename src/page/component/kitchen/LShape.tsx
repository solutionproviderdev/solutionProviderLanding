  ...
  return (
    <div className="p-6 flex flex-col md:flex-row gap-4">
      ...
      <div className="flex-1 mb-6 md:mb-0">
        <h3 className="text-4xl md:text-6xl bg-gradient-to-r from-orange-400 via-yellow-500 to-orange-700 font-semibold mb-4 text-transparent bg-clip-text">
          "L" Shape Kitchen
        </h3>
        <ul className="list-disc list-inside space-y-2 text-lg md:text-2xl text-gray-700">
          <li>Kitchen sizes</li>
...
// const ShapeKitchenL = () => {
//   return (
//     <div>LShapeKitchen</div>
//   )
// }

// export default ShapeKitchenL